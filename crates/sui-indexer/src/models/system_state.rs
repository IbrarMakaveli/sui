...
impl TryFrom<DBValidatorSummary> for SuiValidatorSummary {
    ...
    fn try_from(db: DBValidatorSummary) -> Result<SuiValidatorSummary, Self::Error> {
        Ok(SuiValidatorSummary {
            ...
            operation_cap_id: ID::new(ObjectID::from_str(&db.operation_cap_id)?),
            ...
            staking_pool_id: ID::new(ObjectID::from_str(&db.staking_pool_id)?),
            ...
            exchange_rates_id: ID::new(ObjectID::from_str(&db.exchange_rates_id)?),
